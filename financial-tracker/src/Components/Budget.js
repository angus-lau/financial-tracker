...
const Budget = () => {
  ...
  function handleCategoryClick(category) {
    ...
    // TODO: Expense getting passed undefined as prop rather than category.label
    // <Expense category={category.label}/>
    {selectedCategory && <Expense  category={category.label} />}
